...
public class DbQueries {
	...
	public static final String GET_ACCOUNT_BY_ACCOUNT_NUM = "SELECT u.email, a.balance, a.currencyCode from account a JOIN users u ON a.userId = u.id WHERE a.accountNumber = ?";
	...
	public static final String DELETE_ACCOUNT_BY_EMAIL = "DELETE FROM account WHERE userId IN (SELECT id from users WHERE email = ?)";
